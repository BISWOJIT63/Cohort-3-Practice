...
const App = () => {
  ...
  const deleteProduct = (id)=>{
    setProductsArray(productsArray.filter((elem)=>elem.id !==id));
  }
  return (
    <div className="bg-black text-white flex flex-wrap gap-10 p-5">
      {productsArray.map((elem) => (
        <Cart key={elem.id} product={elem} deleteProduct={deleteProduct} />
      ))}
    </div>
  );
};
