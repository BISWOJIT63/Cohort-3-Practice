...
const Hero = ({ onSearch, onCategorySelect, onShopClick }) => {
  const { products, setCategory, setSort } = useContext(MyStore);
  ...
  useEffect(
    () =>
      setNewItems(() => products.filter((prev) => prev.newArrival === true)),
    [],
  );
  const newArrival = newItems.slice(0, 5);
  const [topRated, setTopRated] = useState([]);
  useEffect(
    () => setTopRated(() => products.filter((prev) => prev.rating >= 4)),
    [],
  );
  const topRatedItem = topRated.slice(0, 5);
  return (
    <main>
      {/* =====================================================
          HERO
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-5 py-20 lg:grid-cols-2 lg:px-8 lg:py-28">
          ...
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-8 text-gray-400">
              Discover quality products, exclusive deals and everything you need
              — all in one place.
            </p>
            ...
            >
              ...
              >
                ...
                <div className="absolute bottom-5 left-5 text-white">
                  ...
                  <p className="mt-1 text-xs text-gray-300 hover:text-blue-500 hover:font-semibold">
                    Explore collection →
                  </p>
                </div>
              </button>
          ...
          <div className="divide-y divide-gray-200 rounded-2xl border border-gray-200 bg-white">
            {newArrival.map((product) => (
              ...
              >
                ...
                <button
                  onClick={() => navigation(`/details/${product.id}`)}
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl bg-indigo-600">
          <div className="relative z-10 px-7 py-14 sm:px-12">
            <p className="font-semibold text-indigo-200">LIMITED TIME OFFER</p>

            <h2 className="mt-3 max-w-xl text-3xl font-bold text-white sm:text-4xl">
              Upgrade your everyday. Save up to 40%.
            </h2>

            <p className="mt-4 max-w-lg text-indigo-100">
              Grab amazing deals across electronics, fashion, gaming and home
              essentials.
            </p>
      ...
      <section className="mx-auto max-w-7xl px-5 py-16 lg:px-8">
        <div className="mb-8">
          ...
          <h2 className="mt-2 text-3xl font-bold">Top Rated Products</h2>
